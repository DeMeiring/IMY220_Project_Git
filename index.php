                    ...
                    <div class="col loginContainer" id="Login">
                        ...
                        <div class="row" id="formLogin">
                            <form action="index.php" class="col-12" method="post">
                                ...
                                <input class="btn col-sm-12" style="color: rgba(245,245,245,0.9)" type="submit" name="lSubmit" id="loginSubmit" value="Log in">
                            </form>
                        </div>
                    ...
                    <div class="col registerContainer" id="Register">
                        ...
                        <div class="row" id="formRegister">
                            <form id="frmControl" class="col-12" action="index.php" method="post">
                                ...
                                <input class="btn col-sm-12" style="color: rgba(245,245,245,0.9);" type="submit" name="rSubmit" id="registerSubmit" value="Register">
                            </form>
                        </div>
                    </div>
                </div>
